...
namespace EmpyrionAPITools
{
    ...
    public static event Action<StatisticsParam> Event_Statistics
    {
      ...
      remove {
        ...
        [ObsoleteAttribute("This event has been deprecated, look to the new GameAPI for its functionality")]     [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1009:DeclareEventHandlersCorrectly")]
